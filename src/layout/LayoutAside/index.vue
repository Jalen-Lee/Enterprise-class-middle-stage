...
import LayoutAsideItem from './LayoutAsideItem'
import LayoutAsideLogo from './LayoutAsideLogo'

export default {
  name: "layout-aside",
  components: {LayoutAsideItem, LayoutAsideLogo},
  data() {
    return {
      sideBarConfig:{
  ...
  computed:{
    //侧边栏状态：收起/展开
    collapsed(){
      return !this.$store.state.app.aside.open
    }
  },
  methods: {
    //sub-menu 展开
